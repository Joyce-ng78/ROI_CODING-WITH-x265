...
def main():
    ...
    ap.add_argument("method_path", type=str, default='output/output_rdo_medium', help='Path to method output')
    ...
    for roi_method in os.listdir(args.method_path) :
        for qp in os.listdir(os.path.join(args.method, roi_method)):  
