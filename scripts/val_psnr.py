...
OUTPUT_ROOT = "./output/output_preset"
REPORT_FILE__PATH = "./results/psnr_results_preset.txt"
REPORT_FILE = "psnr_results_preset.txt"
...
def main():
    ...
    os.makedirs(os.path.dirname(REPORT_FILE__PATH), exist_ok=True)
